...
export default function Team({ navigation, route }) {
  ...
  const renderPlayer = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('RemovePlayer', { teamId, player: item })}
    >
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top','bottom']}>
          ...
          ListHeaderComponent={
            <>
              ...
              <View style={styles.headerContainer}>
                ...
                >
                  <Ionicons name="add" size={28} color="#22396D" />
                </TouchableOpacity>
      ...
      {/* Bottom navigation (hidden when keyboard open) */}
      {!keyboardVisible && (
...
const styles = StyleSheet.create({
  ...
  addIcon:        { position: 'absolute', top: 20, right: 20 },

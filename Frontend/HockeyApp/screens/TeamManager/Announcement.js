...
const announcements = [
  { id: '1', title: 'Important Update',  date: 'Apr 20, 2024', description: 'Lorem ipsum...', image: require('../../assets/logo.png') },
  { id: '2', title: 'Upcoming Meeting',   date: 'Apr 18, 2024', description: 'Lorem ipsum...', image: require('../../assets/logo.png') },
  { id: '3', title: 'Event Announcement', date: 'Apr 10, 2024', description: 'Lorem ipsum...', image: require('../../assets/logo.png') },
];
...
const styles = StyleSheet.create({
  ...
  logo:      { width: '100%', height: 60, resizeMode: 'contain', marginTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 },
  title:     { fontSize: 20, fontWeight: 'bold', textAlign: 'center', color: '#1e3b74', marginVertical: 10 },
  card:      { flexDirection: 'row', backgroundColor: '#f9f9f9', marginHorizontal: 20, marginBottom: 10, borderRadius: 10, padding: 10 },
